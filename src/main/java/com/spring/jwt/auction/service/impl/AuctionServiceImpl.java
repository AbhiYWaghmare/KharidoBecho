...
//import com.spring.jwt.socket.service.AuctionSocketNotifier;
...
////    private final SocketNotificationService socketNotifier;
//    private final AuctionSocketNotifier socketNotifier;
//
//
...
//         socketNotifier.bidPlaced(auctionId, message);
//
//    }
//
...
//            socketNotifier.auctionStarted(a.getAuctionId(), msg);
//
//        }
//    }
//
...
//            );
////            messagingTemplate.convertAndSend("/topic/auction/" + a.getAuctionId(), msg);
//            socketNotifier.auctionEnded(a.getAuctionId(), msg);
//
//        }
//    }
//
...
//                );
////                messagingTemplate.convertAndSend("/topic/auction/" + a.getAuctionId(), msg);
//                socketNotifier.unsold(a.getAuctionId(), msg);
//
//                continue;
//            }
//
...
//            );
////            messagingTemplate.convertAndSend("/topic/auction/" + a.getAuctionId(), msg);
//            socketNotifier.winnerChanged(a.getAuctionId(), msg);
//
//
//        }
//    }
...
//        socketNotifier.winnerAccepted(auctionId, msg);
//
//
//    }
//
