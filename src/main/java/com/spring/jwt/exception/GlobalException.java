...
//    public ResponseEntity<Map<String, Object>> handleCarImageException(
...
public class GlobalException extends ResponseEntityExceptionHandler {
    ...
    // LAPTOP
    @ExceptionHandler(LaptopAlreadyExistsException.class)
    public ResponseEntity<LaptopResponseDTO> handleLaptopAlreadyExists(
            LaptopAlreadyExistsException ex, WebRequest req) {

        LaptopResponseDTO error = new LaptopResponseDTO();
        error.setApiPath(req.getDescription(false).replace("uri=", ""));
        error.setStatus("error");
        error.setMessage(ex.getMessage());
        error.setCode("ALREADY EXISTS");
        error.setStatusCode(HttpStatus.CONFLICT.value());
    ...
    public ResponseEntity<LaptopResponseDTO> handleLaptopNotFound(
            LaptopNotFoundException ex, WebRequest req) {
    ...
    @ExceptionHandler(PhotoNotFoundException.class)
    public ResponseEntity<LaptopResponseDTO> handlePhotoNotFound(
            PhotoNotFoundException ex, WebRequest req) {
